...
import '../../../../assets/js/flot/jquery.flot.time.js';
import '../../../../assets/js/flot/jquery.flot.tooltip.min.js';
...
export class DashboardsComponent implements OnInit {
  ...
  public constructor() {
    this.chartViews = [
      {title: "Headcount", rating: "*****", desc: "Survived not only five centuries, but also the leap scrambled it to make."},
      {title: "Hires vs. Leavers", rating: "****", desc: "Survived not only five centuries, but also the leap scrambled it to make."},
      {title: "per Grade", rating: "***", desc: "Survived not only five centuries, but also the leap scrambled it to make."},
      {title: "per Department", rating: "**", desc: "Survived not only five centuries, but also the leap scrambled it to make."},
      {title: "per Business Unit", rating: "**", desc: "Survived not only five centuries, but also the leap scrambled it to make."},
      {title: "Employment type", rating: "**", desc: "Survived not only five centuries, but also the leap scrambled it to make."},
      {title: "Contract type", rating: "*", desc: "Survived not only five centuries, but also the leap scrambled it to make."},
    ]
